 ...
 *
 * <p>
 * A {@link Category} is used to characterize
 * {@link PointOfInterest}, {@link Event} or {@link Route}. It can contain its
 * own set of sub-categories.
 *
 * @author Pedro Cruz
 *
 */
public class Category extends POI {
     ...
     *
     * @return <code>true</code> if it has sub-categories, <code>false</code>
     * otherwise
     */
